#!/usr/bin/env python3
"""Generate terminal-style PNG screenshots for the Black Cobra Pepper writeup."""
...
""",
    ...
    (
        "03_output_values.png",
        "03_output_values.txt",
        """$ cat output.txt
...
""",
    ...
    (
        "05_linear_attack.png",
        "05_linear_attack.txt",
        """$ python3 solve.py
